...
cat("\n-----------------------------------------------------------\n")
cat("\n-------Testing Logistic Regression with L1 Penalty------\n")
...
cat("\n-----------------------------------------------------------\n")
cat("\n-------Testing Logistic Regression with SCAD/MCP Penalty------\n")
cat("-----------------------\n")
...
cat("\n-----------------------------------------------------------\n")
cat("\n-------Testing Square Root Lasso------\n")
cat("-----------------------\n")
cat("---------n=500, p=800, c=0.1---------\n")
test_sqrt_mse(n=500, p =800, c=0.1)
cat("-----------------------\n")
cat("---------n=500, p=800, c=0.5---------\n")
test_sqrt_mse(n=500, p =800, c=0.5)
cat("-----------------------\n")
cat("---------n=500, p=800, c=1.0---------\n")
test_sqrt_mse(n=500, p =800, c=1.0)