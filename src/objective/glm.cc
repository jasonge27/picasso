...
public:
  LogisticObjective(ObjType obj_type, const double *xmat,  
...
public:
  PoissonObjective(ObjType obj_type, const double* xmat,
    const double* y, int n, int d):
    ObjFunction(obj_type, xmat, y, n, d){
      a = 0.0;
      g = 0.0;
